  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <section className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12">Why Choose Domie?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Every domain gets a beautiful, SEO-optimized landing page with 95+ Lighthouse score
              </CardDescription>
            </CardHeader>
          </Card>
